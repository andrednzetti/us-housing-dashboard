/**
 * Spotlight — card principal do "indicador da semana" da Variação D.
 *
 * Portado de `docs/handoff/dissenha_dashboard/variation-d.jsx` linhas 224-290
 * (apenas o card principal — o aside com Crônica de eventos + Composição da
 * carteira chega no PR 4c-3).
 *
 * Estrutura:
 *
 *   ┌─────────────────────────────────────────────────────────────────┐
 ...
 *
 * @example
 *   <Spotlight indicator={selectSpotlight(file)!} />
 */
...
export function Spotlight({
  ...
  const titleId = `spotlight-${indicator.id}-title`;
