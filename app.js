...
(function () {
  ...
  const SERIES_ORDER = {
    ...
    demand:    ["HSN1F", "EXHOSLUSM495S", "PHSI", "ACTLISCOUUS"],
    prices:    ["CSUSHPISA", "USSTHPI", "MSPUS"],
    sentiment: ["USHMI", "WPU081", "RMI"],
  };
  ...
  const REF_LINES = {
    USHMI:        { value: 50, label: "Neutro (50)", color: "rgba(212,168,67,.5)", dash: [6, 4] },
  ...
  const CONTEXT = {
    ...
    PHSI:           "O Pending Home Sales Index mede contratos assinados (nao fechamentos). Indicador antecedente das vendas de casas existentes.",
    ...
    USHMI:          "O HMI reflete a confianca dos construtores. Acima de 50 = mais construtores otimistas que pessimistas.",
